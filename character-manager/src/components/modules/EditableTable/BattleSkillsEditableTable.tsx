...
interface BattleSkillsEditableTableProps {
...
const BattleSkillsEditableTable: React.FC<BattleSkillsEditableTableProps> = (props) => {
...
export default BattleSkillsEditableTable;
